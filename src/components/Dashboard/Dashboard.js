    ...
    <div className="h-screen py-2 px-4 bg-slate-50 flex flex-col gap-3 overflow-y-auto">
      ...
      <div className="flex flex-col gap-2 justify-center mx-auto">
        <div className="flex gap-4 justify-between ">
          <div className="rounded bg-white border border-slate-100 p-4 flex flex-col gap-2 w-full">
            <div className="">
          ...
          <div className="grid gap-3 grid-rows-3 w-full">
            <div className="rounded bg-white px-3 py-2 w-full flex flex-col gap-2">
              <p className="text-sm">Intent</p>
              <span className="rounded-xl text-xs bg-yellow-200 py-1 px-2 text-yellow-800 w-min">
                Commercial
              </span>
            </div>
            <div className="rounded bg-white px-3 py-2 w-full">
              <p className="">Results</p>
              <p className="text-lg font-semibold">313M</p>
            </div>
            <div className="rounded bg-white px-3 py-2 w-full grid grid-cols-2">
              <div className="">
